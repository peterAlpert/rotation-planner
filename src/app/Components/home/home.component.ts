...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  controllers: Person[] = [
    ...
    { id: 30, name: "يوسف ايمن", role: "كنترول" },
    { id: 31, name: "الخسيني جمال", role: "كنترول" },
    { id: 32, name: "كريم محمود", role: "كنترول" },
    { id: 33, name: "جوفاني عمار", role: "كنترول" },
    { id: 34, name: "كريم احمد", role: "كنترول" },
    { id: 35, name: "فادي نصر", role: "كنترول" },
    { id: 36, name: "امير كمال", role: "كنترول" },
  ];
